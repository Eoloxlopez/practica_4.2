...
namespace Trabajador
{
    public partial class Form1 : Form
    {
        ...
        {
            DialogResult casamiento;
            casamiento = MessageBox.Show("¿Esta usted casado?", "Valor", MessageBoxButtons.YesNo);
            if (casamiento == DialogResult.Yes)
            {
                nuevoTrabajador.Casado = true;
            }
            else
            {
                nuevoTrabajador.Casado = false;
            }
        }
    }
}
